...
CREATE TABLE TRANSACTIONS(TRANSACTION_ID INT(42), PERFORMED DATETIME, AMOUNT DOUBLE(10, 2), DESCRIPTION TEXT, TYPE ENUM('withdraw', 'deposit', 'fee'), NEW_BALANCE DOUBLE(10, 2), ACCOUNT_ID INT(42),
